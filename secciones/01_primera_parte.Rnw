...
parte superior del gráfico y en este caso como el p-valor es superior a un 0.05 para un
nivel de confianza del 95\%, \textbf{no podemos rechazamos la hipótesis nula de igualdad de
...
fuel |> 
 ...
 stat_smooth(formula = y ~ x, 
             ...
             fill = "blue",
             size = 0.5) + 
   labs(title = "Relación entre el tipo de combustible y la cantidad de emisiones de CO2",
        subtitle = "Observar que hay varias curvas paralelas que pertenecen a los diferentes tipos de combustible") +
...
fuel |> 
 ...
 stat_smooth(formula = y ~ x, 
             ...
             fill = "blue",
             size = 0.5) + 
   labs(title = "Relación entre la edad y el ingreso",
        subtitle = "Análisis de varianza") +
   yunkel + theme(axis.text = element_text(size = 13))
@
